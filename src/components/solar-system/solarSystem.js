...
import OnPickTriggerOnMesh from "../../helpers/OnPickTriggerOnMesh";
...
const SolarSystem = (BABYLON, scene, camera) =>{

    let isFocusOnPlanet = false
    const velocity  = 4
    ...
    OnPickTriggerOnMesh(BABYLON, scene, camera, mercury, isFocusOnPlanet, 4)
    ...
    OnPickTriggerOnMesh(BABYLON, scene, camera, earth, isFocusOnPlanet, 8)
